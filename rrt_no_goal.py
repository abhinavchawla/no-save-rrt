...
class RRT_Opt(RRT):
    ...
    def iterate(self):
        if self.current_rand_pt is None or self.current_node is None or self.get_dist(self.current_node, self.current_rand_pt) < self.tolerance/3:
...
if __name__ == '__main__':
    ...
    for test in range(10):
        ...
        rrtsearch2 = RRT_Opt(start, None, [], search_space, 0.01, 5000, 0.03, 'cache/rrt_opt_'+str(test)+'.gif', test_points)
        rrtsearch2.run()
